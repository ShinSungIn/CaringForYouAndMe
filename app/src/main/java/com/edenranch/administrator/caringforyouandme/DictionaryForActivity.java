...
public class DictionaryForActivity extends AppCompatActivity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			...
			case R.id.action_dictionary1 :
				AlertDialog.Builder builder1 = new AlertDialog.Builder(DictionaryForActivity.this);
				builder1.setMessage("" +
					"이 글을 통해\n" +
			...
			case R.id.action_dictionary2:
				AlertDialog.Builder builder2 = new AlertDialog.Builder(DictionaryForActivity.this);
